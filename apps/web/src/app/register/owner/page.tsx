...
const FEATURES = [
  { icon: CalendarDays, label: "Quản lý đặt lịch trực tuyến" },
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm leading-tight text-green-100">Quản lý sân thể thao</p>
            </div>
          </div>
          ...
          <p className="mt-4 max-w-md text-sm text-green-100">
            Đăng ký để quản lý đặt lịch, khách hàng và doanh thu sân của bạn. Sau khi xác thực
            email, tài khoản sẽ được duyệt trước khi kích hoạt.
          </p>
          ...
          {submitted ? (
            <>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Chúng tôi đã gửi link xác thực tới email bạn vừa đăng ký. Sau khi xác thực, tài
                khoản của bạn sẽ chờ admin duyệt trước khi có thể đăng nhập.
              </p>
              <Link
                href="/login"
            ...
            <>
              ...
              <h2 className="mt-3 flex items-center gap-2 text-2xl font-bold">
                Bắt đầu hành trình của bạn <Rocket className="size-5 text-green-600" />
              </h2>
              <p className="mt-1 text-sm text-muted-foreground">
                Tạo tài khoản để bắt đầu quản lý sân thể thao chuyên nghiệp
              </p>
