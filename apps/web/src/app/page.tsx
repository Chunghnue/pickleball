  ...
  return (
    <>
      ...
      <main className="flex flex-1 flex-col">
        <section className="flex flex-col items-center gap-6 bg-gradient-to-b from-blue-50 to-white px-4 py-16 text-center dark:from-blue-950/20 dark:to-background">
        ...
        <section className="flex flex-col items-center gap-4 bg-blue-600 px-4 py-14 text-center text-white">
