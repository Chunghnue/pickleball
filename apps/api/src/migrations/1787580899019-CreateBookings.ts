...
export class CreateBookings1787580899019 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "booking_slots" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "booking_id" character varying NOT NULL, "court_id" character varying NOT NULL, "date" date NOT NULL, "slot_start" TIME NOT NULL, CONSTRAINT "PK_9596369395c8747c94a5606c4de" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_28f69b3b25408c57ebf699ee74" ON "booking_slots"  ("court_id", "date", "slot_start") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_28f69b3b25408c57ebf699ee74"`,
    );
