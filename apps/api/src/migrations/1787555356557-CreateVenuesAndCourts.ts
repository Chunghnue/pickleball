...
export class CreateVenuesAndCourts1787555356557 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "venue_images" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "venue_id" character varying NOT NULL, "url" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3cdef3bcc3a9d5c7a1a47dede36" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."venues_status_enum" AS ENUM('pending_approval', 'active', 'rejected')`,
    );
    await queryRunner.query(
