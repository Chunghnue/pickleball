...
- ~~Bỏ "Widget đặt sân nhanh" dạng sidebar dẫn sang `/dat-san?venueId=...` (mục 5 tài liệu gốc) — route `/dat-san` không tồn tại, `/venues/[id]` là điểm đặt sân duy nhất~~ — **Đã đảo ngược**, xem [2026-09-05-dat-san-online-design.md](./2026-09-05-dat-san-online-design.md): route `/dat-san` được xây để hỗ trợ đặt sân khách vãng lai (không cần đăng nhập); lưới lịch trống ở §4.5 dưới đây đổi thành chỉ xem, click ô trống điều hướng sang `/dat-san`.
